...
{
    const string URL_TEMPLATE_EVENT_COMPETITION_OFFICIALS = 'events/%d/competitions/%d/officials';
    const string URL_TEMPLATE_EVENT_COMPETITION_OFFICIAL = 'events/%d/competitions/%d/officials/%d';

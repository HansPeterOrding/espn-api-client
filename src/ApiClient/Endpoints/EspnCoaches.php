...
{
    const string URL_TEMPLATE_SEASON_COACHES = 'seasons/%d/coaches';
    const string URL_TEMPLATE_SEASON_COACH = 'seasons/%d/coaches/%d';
    const string URL_TEMPLATE_SEASON_TEAM_COACHES = 'seasons/%d/teams/%d/coaches';
